      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-2 text-center sm:text-left">
            ...
            <p className="text-sm leading-relaxed mb-4 max-w-xs mx-auto sm:mx-0">
        ...
        <div className="border-t border-indigo-900 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-center sm:text-left">
