...
const produk = [
  {
    ...
    harga: "450.000",
    img: "https://images.unsplash.com/photo-1672716912467-fd99b71cf780?w=400&q=80",
    badge: "Best Seller",
  ...
  },
  {
    ...
    harga: "650.000",
    img: "https://images.unsplash.com/photo-1724985974881-88d612c52df8?w=400&q=80",
    badge: "Limited",
  ...
  },
  {
    ...
    harga: "380.000",
    img: "https://images.unsplash.com/photo-1604973104381-870c92f10343?w=400&q=80",
    badge: "New",
  ...
  },
  {
    ...
    harga: "520.000",
    img: "https://images.unsplash.com/photo-1616125162686-770bf85622b9?w=400&q=80",
    badge: null,
    badgeColor: "",
  },
  {
    ...
    harga: "280.000",
    img: "https://images.unsplash.com/photo-1609407683391-7d127a00b3e1?w=400&q=80",
    badge: "Favorit",
  ...
  },
  {
    ...
    harga: "750.000",
    img: "https://images.unsplash.com/photo-1543874835-ad7d64196a07?w=400&q=80",
    badge: "Premium",
    ...
    <section id="koleksi" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-indigo-400 max-w-xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {produk.map((p) => (
            <div key={p.nama} className="group rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-indigo-50">
              ...
              <div className="p-5">
                <h3 className="font-bold text-indigo-900 text-lg mb-1">{p.nama}</h3>
                <p className="text-indigo-400 text-sm leading-relaxed mb-4">{p.deskripsi}</p>
                <div className="flex items-center justify-between">
                  <span className="text-indigo-700 font-bold text-lg">Rp {p.harga}</span>
                  <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer"
                    className="bg-indigo-50 hover:bg-indigo-600 hover:text-white text-indigo-600 border border-indigo-200 hover:border-indigo-600 px-4 py-1.5 rounded-full text-sm font-semibold transition-all">
                    Pesan
                  </a>
                </div>
              </div>
        ...
        <div className="text-center mt-12">
          <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-indigo-700 hover:bg-indigo-600 text-white px-8 py-4 rounded-full font-semibold transition-colors">
            Lihat Semua Koleksi
